...
public class ZedToZip {
  // Public Key
  private static BigInteger n = new BigInteger("", 16);
  ...
  private static void convert(String zedFileName) {
    ...
    try {
      // Files
      RandomAccessFile zedFile = new RandomAccessFile(zedFileName, "r");
      String zipFileName = zedFileName.substring(0, zedFileName.lastIndexOf('.')) + ".zip";
      RandomAccessFile zipFile = new RandomAccessFile(zipFileName, "rw");
  ...
  private static byte[] DecodeFirst256B(byte[] content) throws NoSuchAlgorithmException {
